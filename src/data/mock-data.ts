...
export const questions: Question[] = [
  {
    ...
    question: "React 컴포넌트에서 리렌더링이 언제 발생하는지 설명해 주세요.",
    conceptSummary:
    ...
    followUps: ["React.memo는 어떤 경우에 효과가 있나요?", "state를 잘게 나누면 어떤 장단점이 있나요?"],
    sequenceNo: 1,
    isActive: true,
  },
  {
    id: 2,
    slug: "spring-transaction-experience",
    track: "backend",
    category: "Spring Boot",
    questionType: "experience",
    recommendedFramework: "STAR",
    title: "트랜잭션 문제를 해결한 경험이 있나요?",
    question: "실무나 프로젝트에서 트랜잭션 처리 문제를 발견하고 해결한 경험을 설명해 주세요.",
    conceptSummary:
    ...
    followUps: ["외부 API 호출이 트랜잭션 안에 있으면 어떤 문제가 생기나요?", "보정 트랜잭션과 재시도 정책은 어떻게 나눴나요?"],
    sequenceNo: 1,
    isActive: true,
  },
];
